...
client.connect(port, host, function() {
  ...
  //var payloadStr ='{"MA":"1E C0 36 ED 89 55 AA","PT":"01","NB":"02 C8","PV":"'+responseStr+'","SN":"01","SD":"'+cdate+'","ST":"'+time+'","ED":"'+cdate+'","ET":"'+timeEnd+'", "ER" : "00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F"}';
    var payloadStr ='{"MA":"45504D53434F4E543030320A0A","PT":"01","NB":"02 C8","PV":"'+responseStr+'","SN":"01","SD":"'+cdate+'","ST":"'+time+'","ED":"'+cdate+'","ET":"'+timeEnd+'", "ER" : "00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F"}';
